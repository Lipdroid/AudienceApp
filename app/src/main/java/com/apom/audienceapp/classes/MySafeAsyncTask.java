package com.apom.audienceapp.classes;
 ...
 * @param <ResultT>
 */
public abstract class MySafeAsyncTask<ResultT> implements Callable<ResultT> {
     ...
     */
    public MySafeAsyncTask(Handler handler) {
     ...
     */
    public MySafeAsyncTask(Executor executor) {
        this.executor = executor;
    }

    public MySafeAsyncTask(Handler handler, Executor executor) {
        this.handler = handler;
        this.executor = executor;
    }
    ...
    public MySafeAsyncTask<ResultT> executor(Executor executor) {
        this.executor = executor;
        return this;
    }
    ...
    public MySafeAsyncTask<ResultT> handler(Handler handler) {
        this.handler = handler;
        return this;
    }
    ...
    public static class Task<ResultT> implements Callable<Void> {
        protected MySafeAsyncTask<ResultT> parent;
        protected Handler handler;

        public Task(MySafeAsyncTask<ResultT> parent) {
            this.parent = parent;
